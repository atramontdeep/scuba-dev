import{v as l,c as s,w as C,a as z,b as P,e as p,u as i,t as _,x as me,y as fe,o as w}from"./vue.esm-bundler-BXouRCJi.js";import{_ as ye}from"./_plugin-vue_export-helper-DlAUqK2U.js";const be={class:"scuba-toggle__container"},ue=["id","disabled","aria-label"],xe={__name:"Toggle",props:{modelValue:{type:Boolean,default:!1},label:{type:String,default:""},labelPosition:{type:String,default:"right",validator:e=>["left","right","none"].includes(e)},size:{type:String,default:"md",validator:e=>["sm","md","lg"].includes(e)},disabled:{type:Boolean,default:!1},id:{type:String,default:null},ariaLabel:{type:String,default:""}},emits:["update:modelValue","change"],setup(e,{emit:o}){const n=e,r=o,a=l(n.modelValue),T=s(()=>n.id?n.id:"scuba-toggle-"+Math.random().toString(36).substr(2,9)),L=s(()=>a.value===!0),ae=s(()=>n.label&&n.labelPosition==="left"),oe=s(()=>n.label&&n.labelPosition==="right"),k=s(()=>"scuba-toggle__label"),ie=s(()=>{const t=["scuba-toggle"];return t.push("scuba-toggle--"+n.size),n.disabled&&t.push("scuba-toggle--disabled"),n.label||t.push("scuba-toggle--no-label"),t}),re=s(()=>{const t=["scuba-toggle__track"];return L.value?t.push("scuba-toggle__track--checked"):t.push("scuba-toggle__track--unchecked"),n.disabled&&t.push("scuba-toggle__track--disabled"),t}),pe=s(()=>{const t=["scuba-toggle__thumb"];return L.value&&t.push("scuba-toggle__thumb--checked"),t});C(()=>n.modelValue,t=>{a.value=t}),C(a,t=>{r("update:modelValue",t)});const ge=t=>{r("change",t)};return(t,S)=>(w(),z("label",{class:i(ie.value)},[ae.value?(w(),z("span",{key:0,class:i(k.value)},_(e.label),3)):P("",!0),p("div",be,[me(p("input",{id:T.value,"onUpdate:modelValue":S[0]||(S[0]=ce=>a.value=ce),type:"checkbox",disabled:e.disabled,class:"scuba-toggle__input","aria-label":e.ariaLabel,onChange:ge},null,40,ue),[[fe,a.value]]),p("div",{class:i(re.value)},[p("div",{class:i(pe.value)},null,2)],2)]),oe.value?(w(),z("span",{key:1,class:i(k.value)},_(e.label),3)):P("",!0)],2))}},d=ye(xe,[["__scopeId","data-v-d1200a15"]]),Te={title:"Scuba/Toggle",component:d,tags:["autodocs"],argTypes:{size:{control:"select",options:["sm","md","lg"],description:"Tamanho do toggle"},labelPosition:{control:"select",options:["left","right","none"],description:"Posição do label"},label:{control:"text",description:"Texto do label"},disabled:{control:"boolean",description:"Estado desabilitado"}}},g=()=>({components:{Toggle:d},setup(){return{enabled:l(!0)}},template:`
  ...
  `}),y=()=>({components:{Toggle:d},setup(){return{enabled:l(!0)}},template:`
    <div style="padding: 40px; font-family: Poppins, sans-serif;">
      <Toggle v-model="enabled" label="Large toggle" size="lg" />
    </div>
  `}),b=()=>({components:{Toggle:d},setup(){const e=l(!1),o=l(!0);return{enabled:e,enabledChecked:o}},template:`
    <div style="padding: 40px; font-family: Poppins, sans-serif;">
  ...
  \`
})`,...(U=(B=m.parameters)==null?void 0:B.docs)==null?void 0:U.source}}};var I,N,F;f.parameters={...f.parameters,docs:{...(I=f.parameters)==null?void 0:I.docs,source:{originalSource:`() => ({
  components: {
    Toggle
  },
  setup() {
  ...
  \`
})`,...(F=(N=f.parameters)==null?void 0:N.docs)==null?void 0:F.source}}};var q,R,G;y.parameters={...y.parameters,docs:{...(q=y.parameters)==null?void 0:q.docs,source:{originalSource:`() => ({
  components: {
    Toggle
  },
  setup() {
  ...
  \`
})`,...(G=(R=y.parameters)==null?void 0:R.docs)==null?void 0:G.source}}};var H,W,J;b.parameters={...b.parameters,docs:{...(H=b.parameters)==null?void 0:H.docs,source:{originalSource:`() => ({
  components: {
    Toggle
  },
  setup() {
  ...
  \`
})`,...(J=(W=b.parameters)==null?void 0:W.docs)==null?void 0:J.source}}};var K,Q,X;u.parameters={...u.parameters,docs:{...(K=u.parameters)==null?void 0:K.docs,source:{originalSource:`() => ({
  components: {
    Toggle
  },
  setup() {
  ...
  \`
})`,...(se=(de=h.parameters)==null?void 0:de.docs)==null?void 0:se.source}}};const ze=["Playground","Default","Small","Medium","Large","Disabled","LabelLeft","NoLabel","AllSizesAndStates","DesignTokens"];export{v as AllSizesAndStates,c as Default,h as DesignTokens,b as Disabled,u as LabelLeft,y as Large,f as Medium,x as NoLabel,g as Playground,m as Small,ze as __namedExportsOrder,Te as default};
