import{T as p}from"./TaskBar-axOWGFFw.js";import"./vue.esm-bundler-cjlVRrb_.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const V={title:"Scuba/TaskBar",component:p,tags:["autodocs"],argTypes:{current:{control:"number",description:"Valor atual (número de tarefas concluídas)"},total:{control:"number",description:"Total de tarefas"}}},t=U=>({components:{TaskBar:p},setup(){return{args:U}},template:'<TaskBar v-bind="args" />'}),e=t.bind({});e.args={current:21,total:200};const r=t.bind({});r.args={current:0,total:200};const o=t.bind({});o.args={current:21,total:200};const n=t.bind({});n.args={current:45,total:80};const a=t.bind({});a.args={current:160,total:200};const s=t.bind({});s.args={current:10,total:10};const d=()=>({components:{TaskBar:p},template:`
