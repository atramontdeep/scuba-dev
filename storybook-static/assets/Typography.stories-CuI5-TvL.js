const x={title:"Scuba/Typography",parameters:{docs:{description:{component:"Estilos de tipografia do Scuba Design System. Todos os textos usam Poppins e context-color-text-primary."}}}},t=()=>({template:`
...
&lt;h3 class="heading-2xl"&gt;Seção&lt;/h3&gt;</pre>
  ...
  `});var n,i,d;t.parameters={...t.parameters,docs:{...(n=t.parameters)==null?void 0:n.docs,source:{originalSource:`() => ({
  template: \`
    <div style="padding: 40px; font-family: Poppins, sans-serif;">
      <h2 style="margin-bottom: 40px; font-size: 24px; font-weight: 600;">Headings do Scuba</h2>
  ...
  \`
})`,...(d=(i=t.parameters)==null?void 0:i.docs)==null?void 0:d.source}}};var r,p,s;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`() => ({
  template: \`
    <div style="padding: 40px; font-family: Poppins, sans-serif;">
      <h2 style="margin-bottom: 24px; font-size: 24px; font-weight: 600;">Classes CSS Recomendadas</h2>
...
&lt;h3 class="heading-2xl"&gt;Seção&lt;/h3&gt;</pre>
  ...
  \`
})`,...(s=(p=e.parameters)==null?void 0:p.docs)==null?void 0:s.source}}};var a,l,g;o.parameters={...o.parameters,docs:{...(a=o.parameters)==null?void 0:a.docs,source:{originalSource:`() => ({
  template: \`
    <div style="padding: 40px; font-family: Poppins, sans-serif;">
      <h2 style="margin-bottom: 24px; font-size: 24px; font-weight: 600;">Tokens de Tipografia</h2>
  ...
  \`
})`,...(g=(l=o.parameters)==null?void 0:l.docs)==null?void 0:g.source}}};const b=["Headings","CSSClasses","DesignTokens"];export{e as CSSClasses,o as DesignTokens,t as Headings,b as __namedExportsOrder,x as default};
