import{q as d,c as b,w as N,B as Ft,J as D,a as r,e as P,F as U,u as K,y as Ht,p as f,o as c,D as g,x as u,b as j,t as q,r as Mt,h as Ot}from"./vue.esm-bundler-cjlVRrb_.js";import{_ as qt}from"./_plugin-vue_export-helper-DlAUqK2U.js";const Rt=["aria-orientation"],Lt=["aria-selected","aria-controls","id","tabindex","disabled","onClick","onKeydown"],Nt={class:"scuba-tabs__label"},Ut={key:1,class:"scuba-tabs__badge"},Kt={class:"scuba-tabs__panels"},jt=["id","aria-labelledby"],Yt={__name:"Tabs",props:{modelValue:{type:[String,Number],default:null},tabs:{type:Array,required:!0,validator:o=>o.every(i=>typeof i=="object"&&"label"in i)},orientation:{type:String,default:"horizontal",validator:o=>["horizontal","vertical"].includes(o)},fullWidth:{type:Boolean,default:!1},size:{type:String,default:"sm",validator:o=>["sm"].includes(o)},showIcons:{type:Boolean,default:!1},id:{type:String,default:null}},emits:["update:modelValue","change"],setup(o,{emit:i}){const n=o,m=i,M=d(null),V=d({}),h=d(null),R=b(()=>n.id?`${n.id}-tab`:"scuba-tab-"+Math.random().toString(36).substr(2,9)),L=b(()=>n.id?`${n.id}-panel`:"scuba-panel-"+Math.random().toString(36).substr(2,9)),O=b(()=>n.modelValue!==null?n.tabs.find(t=>t.value===n.modelValue):n.tabs.find(t=>!t.disabled)||n.tabs[0]),Bt=b(()=>n.tabs.indexOf(O.value)),Wt=b(()=>{const t=["scuba-tabs"];return t.push("scuba-tabs--underline"),t.push(`scuba-tabs--${n.orientation}`),t.push(`scuba-tabs--${n.size}`),t}),Dt=b(()=>{const t=["scuba-tabs__list"];return n.fullWidth&&t.push("scuba-tabs__list--full-width"),t}),A=t=>t===O.value,Pt=t=>{const e=["scuba-tabs__tab"];return A(t)&&e.push("scuba-tabs__tab--active"),t.disabled&&e.push("scuba-tabs__tab--disabled"),e},$t=t=>{const e=["scuba-tabs__panel"];return A(t)&&e.push("scuba-tabs__panel--active"),e},B=t=>{t.disabled||(m("update:modelValue",t.value),m("change",t),D(()=>{x()}))},W=t=>{const e=n.tabs.filter(p=>!p.disabled);if(e.length===0)return;let s=e.indexOf(O.value)+t;s<0?s=e.length-1:s>=e.length&&(s=0),B(e[s])},Et=()=>{const t=n.tabs.find(e=>!e.disabled);t&&B(t)},kt=()=>{const t=n.tabs.filter(e=>!e.disabled);t.length>0&&B(t[t.length-1])},x=()=>{if(!M.value||!h.value)return;const e=h.value.querySelectorAll(".scuba-tabs__tab")[Bt.value];if(!e)return;const a=e.getBoundingClientRect(),s=h.value.getBoundingClientRect();n.orientation==="horizontal"?V.value={width:`${a.width}px`,transform:`translateX(${a.left-s.left}px)`}:V.value={height:`${a.height}px`,transform:`translateY(${a.top-s.top}px)`}};return N(()=>n.modelValue,()=>{D(()=>{x()})}),N(()=>n.tabs,()=>{D(()=>{x()})},{deep:!0}),Ft(()=>{if(n.modelValue===null){const t=n.tabs.find(e=>!e.disabled);t&&m("update:modelValue",t.value)}D(()=>{x()}),window.addEventListener("resize",x)}),(t,e)=>(c(),r("div",{class:f(Wt.value)},[P("div",{ref_key:"tabListRef",ref:h,class:f(Dt.value),role:"tablist","aria-orientation":o.orientation},[(c(!0),r(U,null,K(o.tabs,(a,s)=>(c(),r("button",{key:a.value||s,class:f(Pt(a)),role:"tab","aria-selected":A(a),"aria-controls":`${L.value}-${s}`,id:`${R.value}-${s}`,tabindex:A(a)?0:-1,disabled:a.disabled,onClick:p=>B(a),onKeydown:[e[0]||(e[0]=g(u(p=>W(1),["prevent"]),["right"])),e[1]||(e[1]=g(u(p=>W(-1),["prevent"]),["left"])),e[2]||(e[2]=g(u(p=>W(1),["prevent"]),["down"])),e[3]||(e[3]=g(u(p=>W(-1),["prevent"]),["up"])),g(u(Et,["prevent"]),["home"]),g(u(kt,["prevent"]),["end"])]},[a.icon&&o.showIcons?(c(),r("i",{key:0,class:f(["ph",a.icon,"scuba-tabs__icon"])},null,2)):j("",!0),P("span",Nt,q(a.label),1),a.badge?(c(),r("span",Ut,q(a.badge),1)):j("",!0)],42,Lt))),128)),P("div",{ref_key:"indicator",ref:M,class:"scuba-tabs__indicator",style:Ht(V.value)},null,4)],10,Rt),P("div",Kt,[(c(!0),r(U,null,K(o.tabs,(a,s)=>(c(),r("div",{key:a.value||s,class:f($t(a)),role:"tabpanel",id:`${L.value}-${s}`,"aria-labelledby":`${R.value}-${s}`,tabindex:0},[Mt(t.$slots,a.value||`panel-${s}`,{tab:a},()=>[Ot(q(a.content),1)],!0)],10,jt))),128))])],2))}},I=qt(Yt,[["__scopeId","data-v-e775fb00"]]),H=[{value:"tab1",label:"Tab 1",icon:"ph-house",content:"Conteúdo da Tab 1"},{value:"tab2",label:"Tab 2",icon:"ph-user",content:"Conteúdo da Tab 2"},{value:"tab3",label:"Tab 3",icon:"ph-gear",content:"Conteúdo da Tab 3"}],Gt=[{value:"inbox",label:"Inbox",icon:"ph-inbox",badge:"12",content:"Mensagens na caixa de entrada"},{value:"drafts",label:"Rascunhos",icon:"ph-note",badge:"3",content:"Seus rascunhos salvos"},{value:"sent",label:"Enviados",icon:"ph-paper-plane-tilt",content:"Mensagens enviadas"},{value:"trash",label:"Lixeira",icon:"ph-trash",content:"Itens na lixeira"}],Jt=[{value:"1",label:"Dashboard",icon:"ph-house",content:"Dashboard content"},{value:"2",label:"Analytics",icon:"ph-chart-line",content:"Analytics content"},{value:"3",label:"PhUsers",icon:"ph-users",content:"PhUsers content"},{value:"4",label:"Settings",icon:"ph-gear",content:"Settings content"},{value:"5",label:"Reports",icon:"ph-file-text",content:"Reports content"},{value:"6",label:"Messages",icon:"ph-envelope",content:"Messages content"},{value:"7",label:"PhCalendar",icon:"ph-calendar",content:"PhCalendar content"},{value:"8",label:"Tasks",icon:"ph-check-square",content:"Tasks content"}],Zt={title:"Scuba/Tabs",component:I,tags:["autodocs"],argTypes:{tabs:{control:"object",description:"Array de tabs"},modelValue:{control:"text",description:"Tab ativa (v-model)"},orientation:{control:"select",options:["horizontal","vertical"],description:"Orientação das tabs"},fullWidth:{control:"boolean",description:"Tabs ocupam largura total"},size:{control:"select",options:["sm"],description:"Tamanho das tabs"},showIcons:{control:"boolean",description:"Exibir ícones nas tabs"}}},l=o=>({components:{Tabs:I},setup(){var n;const i=d(o.modelValue||((n=o.tabs[0])==null?void 0:n.value));return{args:o,activeTab:i}},template:'<Tabs v-bind="args" v-model="activeTab" />'}),v=l.bind({});v.args={tabs:H,modelValue:"tab1",orientation:"horizontal",size:"sm",showIcons:!1};v.parameters={docs:{description:{story:"Use os controles abaixo para testar diferentes configurações das tabs."}}};const y=l.bind({});y.args={tabs:H,modelValue:"tab1",orientation:"horizontal",size:"sm",showIcons:!1};const T=l.bind({});T.args={tabs:[{value:"home",label:"Home",icon:"ph-house",content:"Home content"},{value:"profile",label:"Perfil",icon:"ph-user",content:"Profile content"},{value:"settings",label:"Configurações",icon:"ph-gear",content:"Settings content"},{value:"notifications",label:"Notificações",icon:"ph-bell",content:"Notifications content"}],modelValue:"home",showIcons:!0};const w=l.bind({});w.args={tabs:Gt,modelValue:"inbox",showIcons:!0};const z=l.bind({});z.args={tabs:[{value:"tab1",label:"Tab 1",content:"Conteúdo da Tab 1"},{value:"tab2",label:"Tab 2 (Disabled)",content:"Conteúdo da Tab 2",disabled:!0},{value:"tab3",label:"Tab 3",content:"Conteúdo da Tab 3"}],modelValue:"tab1"};const S=l.bind({});S.args={tabs:H,modelValue:"tab1",fullWidth:!0};const C=l.bind({});C.args={tabs:Jt,modelValue:"1"};const _=l.bind({});_.args={tabs:H,modelValue:"tab1",orientation:"vertical"};const $=()=>({components:{Tabs:I},setup(){const o=d("overview");return{tabs:[{value:"overview",label:"Overview",icon:"ph-house"},{value:"details",label:"Details",icon:"ph-info"},{value:"settings",label:"Settings",icon:"ph-gear"}],activeTab:o}},template:`
  ...
  `});var Y,G,J;v.parameters={...v.parameters,docs:{...(Y=v.parameters)==null?void 0:Y.docs,source:{originalSource:`args => ({
  components: {
    Tabs
  },
  setup() {
...
})`,...(J=(G=v.parameters)==null?void 0:G.docs)==null?void 0:J.source}}};var X,Q,Z;y.parameters={...y.parameters,docs:{...(X=y.parameters)==null?void 0:X.docs,source:{originalSource:`args => ({
  components: {
    Tabs
  },
  setup() {
